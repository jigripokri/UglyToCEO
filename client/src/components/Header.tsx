        ...
        <div className="relative flex flex-row items-center justify-center gap-0">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative w-[90px] h-[120px] md:w-[120px] md:h-[160px] rounded-xl overflow-hidden shadow-lg -mr-0.5 md:-mr-1 z-10"
              style={{
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative w-[90px] h-[120px] md:w-[120px] md:h-[160px] rounded-xl overflow-hidden shadow-lg -ml-0.5 md:-ml-1 z-10"
              style={{
                boxShadow: "0 8px 32px rgba(0,0,0,0.15), 0 2px 8px rgba(0,0,0,0.1)"
              }}
            >
